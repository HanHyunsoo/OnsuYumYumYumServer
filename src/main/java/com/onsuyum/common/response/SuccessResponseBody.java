...
public class SuccessResponseBody<T> extends AbstractResponseBody {
    ...
    @Builder
    public SuccessResponseBody(int status, String statusDetail, String code, String message, T data) {
    ...
    public static <T> ResponseEntity<SuccessResponseBody<T>> toEmptyResponseEntity(StatusEnum statusEnum) {
        return ResponseEntity
                .status(statusEnum.getHttpStatus())
                .body(SuccessResponseBody.<T>builder()
                        .status(statusEnum.getHttpStatus().value())
