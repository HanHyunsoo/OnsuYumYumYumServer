...
public class MultipartRestaurantRequest extends JsonRestaurantRequest {
    ...
    public MultipartRestaurantRequest(String name, String phone, List<String> time, String summary, String location, Double longitude, Double latitude, MultipartFile outsideImage, MultipartFile insideImage) {
