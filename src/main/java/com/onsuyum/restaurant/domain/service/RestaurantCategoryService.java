...
public class RestaurantCategoryService {
    ...
    @Transactional
    public Map<String, Object> saveAllRestaurantCategoryWithRequest(Long id,
            Set<String> categoryNames, boolean checkRequest) {
    ...
    public Page<RestaurantResponse> findAllRestaurantByCategoryId(Pageable pageable, Long id) {
        ...
        Page<RestaurantCategory> restaurantCategories = restaurantCategoryRepository.findAllByCategory(
                pageable, category);
    ...
    @Transactional(readOnly = true)
    public Page<RestaurantResponse> findAllRestaurantByCategoryIdWithRequest(Pageable pageable,
            Long id) {
        Category category = categoryService.findEntityById(id);

        Page<RestaurantCategory> restaurantCategories = restaurantCategoryRepository.findAllByCategoryWithRequest(
                pageable, category);
    ...
    @Transactional(readOnly = true)
    public Page<CategoryResponse> findAllCategoryByRestaurantIdWithRequest(Pageable pageable,
            Long id, boolean checkRequest) {
        Restaurant restaurant = restaurantService.findEntityById(id);
        ...
        Page<RestaurantCategory> restaurantCategories = restaurantCategoryRepository.findAllByRestaurant(
                pageable, restaurant);
