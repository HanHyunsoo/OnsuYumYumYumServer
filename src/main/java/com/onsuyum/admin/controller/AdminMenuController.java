...
public class AdminMenuController {
    ...
    public ResponseEntity<SuccessResponseBody<List<MenuResponse>>> saveAll(
        ...
        List<MenuResponse> menuResponses = menuService.saveAll(id,
                multipartMenuRequestList.getMenuRequestList());
    ...
    public ResponseEntity<SuccessResponseBody<MenuResponse>> saveMenuImageById(
            @PathVariable @Parameter(description = "메뉴 Id") Long id,
    ...
    public ResponseEntity<SuccessResponseBody<MenuResponse>> findById(
